 ...
 * Dato un nodo [i], infatti, il nodo padre avrà indice [i / 2], i nodi figli [i * 2] e [i * 2 + 1].
 */
 ...
 */
binaryheap* initBinaryHeap(int (*compare)(void*, void*)) {
 ...
 * L'algortimo ha complessità log_2(n).
 */
